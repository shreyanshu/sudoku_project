...
smooth = cv2.GaussianBlur(warpg,(3,3),3) #blurs the image using gaussian blur
thresh = cv2.adaptiveThreshold(smooth,255,0,1,5,2) #tresholds the image 
...
sudof= sudo.flatten()# flatten to one d array
# print(sudo)	
